...
<body>
    ...
    <div class="tab">
        ...
        <button class="tablinks" onclick="openCategory(event, 'Moisturiser')">Moisturiser and SPF</button>
        <button class="tablinks" onclick="openCategory(event, 'Sunscreen')">Sunscreen</button>
    </div>
    ...
    <div class="hero" style="background-image: url('images/header.jpg');">
        ...
        $categories = ['Cleanser', 'Toner', 'Serum', 'Moisturiser', 'Sunscreen'];

        foreach ($categories as $category) {
            echo "<div id='$category' class='tabcontent'>";
